...
public class login extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        // login for multiuser login without use data base connection
        
        //here we set 2 user 
        //1 username=admain password=abc
        //2 username=boss password=123
        if(user.equals("admin")&&pass.equals("pass")){
            new Menu().setVisible(true);//open home page
            this.setVisible(false);
        }
        else if(user.equals("java")&&pass.equals("123")){
           new Menu().setVisible(true);
            this.setVisible(false);//open home page
        }
        else{
